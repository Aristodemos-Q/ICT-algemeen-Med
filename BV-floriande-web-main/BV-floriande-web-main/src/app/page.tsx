...
export default function Home() {
  ...
  // Don't show redirect loading for authenticated users on homepage
  // if (user) {
  //   return (
  //     <div className="min-h-screen bg-gradient-to-br from-secondary/10 to-primary/10">
  //       <div className="flex min-h-screen items-center justify-center">
  ...
  // Homepage content voor zowel ingelogde als niet-ingelogde gebruikers
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/10 via-white to-secondary/20">
      {/* Header met navigatie */}
      <header className="py-4 bg-primary text-white shadow-lg">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center">
            <div className="bg-white rounded-lg p-1 mr-4 shadow-lg flex-shrink-0 border-2 border-secondary">
              <img 
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Badminton Vereniging</p>
            </div>
          </div>
            ...
            {user ? (
              ...
              <>
                <Link 
                  ...
                  className="px-5 py-2 rounded-lg bg-white text-primary hover:bg-opacity-90 transition-colors font-medium shadow-sm"
                >
                  Dashboard
                </Link>
                <button
                  ...
                  className="px-5 py-2 rounded-lg border border-white text-white hover:bg-white hover:text-primary transition-colors font-medium"
                >
                  Uitloggen
                </button>
              </>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
          <div className="md:w-1/2">
            <h1 className="text-5xl font-bold text-primary mb-6 leading-tight">
              <span className="text-secondary">Badminton</span> Vereniging<br/>Floriande Trainers Platform
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                href="/login"
                className="px-8 py-3 rounded-lg bg-primary text-white hover:bg-primary/90 transition-all font-medium shadow-lg hover:shadow-xl hover:translate-y-[-2px]"
              >
                Inloggen
              </Link>
              <Link 
                href="/register"
                className="px-8 py-3 rounded-lg bg-white text-primary border-2 border-primary hover:bg-primary/5 transition-all font-medium shadow-md hover:shadow-lg hover:translate-y-[-2px]"
              >
                Account aanmaken
              </Link>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-[500px]">
              <div className="bg-white rounded-xl shadow-2xl overflow-hidden border-2 border-primary">
                {/* Blauwe band bovenaan */}
                <div className="h-16 bg-primary"></div>
                
                {/* Center gedeelte met logo */}
                <div className="py-10 px-4 flex items-center justify-center bg-white">
                  <img 
                    src="/bv florande2.webp" 
                    alt="BV Floriande Logo" 
                ...
                {/* Blauwe band onderaan */}
                <div className="h-16 bg-primary"></div>
              </div>
              
              {/* Gele balk met "Trainers Platform" tekst */}
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-secondary text-primary px-10 py-3 rounded-full font-bold shadow-lg text-xl border-2 border-primary">
                Trainers Platform
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="font-bold text-lg">Badminton Vereniging Floriande</span>
            </div>
